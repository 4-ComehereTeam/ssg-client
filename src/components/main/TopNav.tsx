            ...
            <nav className="overflow-auto w-full top-0 left-0 sticky z-50 bg-white ">
                <ul className="flex justify-between text-[15px] leading-3 font-normal  whitespace-nowrap">
                    <li className="text-center my-auto flex-grow font-[Pretendard-Light] ">
                        <Link href="/" 
                        className={underline == "홈" ? "border-b-[3px] border-black pb-[10px] font-bold" : ""}
                        onClick={() => callCurrentInner("홈")}
                        >홈</Link>
                    </li>
                    <li className="text-center my-auto flex-grow font-[Pretendard-Light]">
                        <Link href="/specialPrice"
                        className={underline == "특가" ? "border-b-[3px] border-black pb-[10px] font-bold" : ""}
                        onClick={() => callCurrentInner("특가")}
                        >특가</Link>
                    </li>
                    <li className="text-center my-auto flex-grow font-[Pretendard-Light]">
                        <Link href="#"
                        className={underline == "베스트" ? "border-b-[3px] border-black pb-[10px] font-bold" : ""}
                        onClick={() => callCurrentInner("베스트")}
                        >베스트</Link>
                    </li>
                    <li className="text-center my-auto flex-grow font-[Pretendard-Light]">
                        <Link href="#"
                        className={underline == "명품" ? "border-b-[3px] border-black pb-[10px] font-bold" : ""}
                        onClick={() => callCurrentInner("명품")}
                        >명품</Link>
                    </li>
                    <li className="text-center my-auto flex-grow font-[Pretendard-Light]">
                        <Link href="#"
                        className={underline == "뷰티" ? "border-b-[3px] border-black pb-[10px] font-bold" : ""}
                        onClick={() => callCurrentInner("뷰티")}
                        >뷰티</Link>
                    </li>
                    <li className="text-center my-auto flex-grow font-[Pretendard-Light]">
                        <Link href="#"
                        className={underline == "패션" ? "border-b-[3px] border-black pb-[10px] font-bold" : ""}
                        onClick={() => callCurrentInner("패션")}
                        >패션</Link>
                    </li>
                    <li className="my-auto flex-grow font-[Pretendard-Light]">
                        <Link href="#"
                        className={underline == "SSGTV" ? "border-b-[3px] border-black pb-[10px] font-bold" : ""}
                    ...
                    <li className="text-center my-auto flex-grow font-[Pretendard-Light]">
                        <Link href="#"
                        className={underline == "브랜드" ? "border-b-[3px] border-black pb-[10px] font-bold" : ""}
