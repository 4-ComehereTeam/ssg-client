    ...
    return(
        <>
            ...
            >
                ...
                <h3 className="text-[14px] w-full text-center mx-auto relative left-[10px]">{title}</h3>
                <Link
                    className="w-[50px] h-full items-center flex justify-center"
                    href={"#"}
                >
                    <Image width="27" height="27" className='mx-auto' src="https://img.icons8.com/ios/27/search--v1.png" alt="searchIcon"/>
                </Link>
                <Link
                    className="w-[50px] h-full items-center flex justify-center"
                    href={"#"}
                >
                    <Image width="24" height="22" className='mx-auto' src={Home} alt="backButton"/>
                </Link>
            </header>
        </>
    )
