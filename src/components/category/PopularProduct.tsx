...
import { getItemBasicInfo, getItemBrand, getItemCalc, getItemThumbnail } from '@/actions/item'
import { faArrowUpAZ } from '@fortawesome/free-solid-svg-icons';
// import FillStarIcon from '@/images/svgs/FillStarIcon'

export default async function PopularProduct({ id, src, store, brand, name, price, sale, salePrice, reviewRating, reviewCount,imageUrl, alt }: ProductDataType) {
              ...
              <div className='flex flex-col'>
                ...
                <div className='mt-[0.125rem] mb-0 flex flex-row'>
                  ...
                  <em className='mt-0 -me-0 mb-0 ms-[0.25rem] font-semibold not-italic'>
                    <span className='border-0 w-[1px] h-[1px] -my-px -mx-px px-0 py-0 overflow-hidden whitespace-nowrap absolute'>판매가격</span>
                    {info.price * Math.abs((info.discountRate - 100) / 100)}원
                  </em>
                </div>
              </div>
            </div>
