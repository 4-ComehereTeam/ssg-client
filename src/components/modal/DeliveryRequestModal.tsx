                ...
                <div className="fixed inset-x-0 top-0 bottom-0 flex flex-col border  bg-white">
                    ...
                    <div className='my-[20px] px-[16px]'>
                        ...
                        <ul>
                            <li className="flex items-center my-2">
                                ...
                                <span className="text-[13px] peer-checked:font-bold tracking-[-0.3px]">부재 시 경비실에 맡겨주세요</span>
                            </li>
                            <li className="flex items-center my-2">
                                <input type="radio" className="w-[18px] h-[18px] mr-2 peer accent-red-500" name="requestList"/>
                                <span className="text-[13px] peer-checked:font-bold tracking-[-0.3px]" >부재 시 문 앞에 놓아주세요</span>
                            </li>
                            <li className="flex items-center my-2">
                                <input type="radio" className="w-[18px] h-[18px] mr-2 peer accent-red-500" name="requestList"/>
                                <span className="text-[13px] peer-checked:font-bold tracking-[-0.3px]">직접 받겠습니다</span>
                            </li>
                            <li className="flex items-center my-2">
                                <input type="radio" className="w-[18px] h-[18px] mr-2 peer accent-red-500" name="requestList"/>
                                <span className="text-[13px] peer-checked:font-bold tracking-[-0.3px]" >배송 전에 연락주세요</span>
                            </li>
                            <li className="flex items-center my-2">
                    ...
                    <div className='my-[20px] px-[16px]'>
                        <p className="flex items-center">
                            ...
                            <span className="ml-2 text-red-500 font-bold tracking-[-0.3px]">다음 배송에도 계속 사용할게요</span>
                        </p>
                        <span className="text-[12px] tracking-[-0.3px] text-[#888888]">편리한 배송을 위해 배송 목적에 한해 사용하겠습니다</span>
                    </div>
