...
export default function QuickMenu(){
    ...
    const progress = (event:any) => {
        ...
        // 스크롤한 비율 계산
        const percentScrolled = Math.ceil((scrollLeft / 415) * 100);
        ...
        <div className="overflow-auto scrollbar-hide" onScroll={progress}>
            <div className="w-[750px] m-4" >
                <div className="flex ">
                    ...
                    <QuickMenuItem name="쓱1DAY배송" path="https://m.ssg.com/page/dvstore_oneday.ssg?mGnbYn=N" src="https://simg.ssgcdn.com/trans.ssg?src=/cmpt/banner/202401/2024010509125498828183756818_909.png&amp;w=128&amp;h=128"/>
                    <QuickMenuItem name={"트레이더스\n 쓱배송"} path="https://m.ssg.com/page/dvstore_traders.ssg?mGnbYn=N" src="https://simg.ssgcdn.com/trans.ssg?src=/cmpt/banner/202401/2024010509144825099566803066_188.png&amp;w=128&amp;h=128"/>
