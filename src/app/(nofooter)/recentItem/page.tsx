  ...
  const productData = [
    {
      ...
      discount: 0,
      imageUrl:
        "https://sitem.ssgcdn.com/87/77/06/item/1000583067787_i1_750.jpg",
    },
    {
      productId: 2,
      vendorName: "S BLANC",
      ...
      discount: 10,
      imageUrl:
        "https://sitem.ssgcdn.com/70/99/40/item/1000583409970_i1_750.jpg",
    },
  ]
  ...
  return (
    <div className=" bg-gray-100 p-4 h-screen">
      <div className="flex items-center mt-3">
        ...
        <p className="flex-grow  text-lg text-center font-bold tracking-[-1px]">
          최근 본 상품
        </p>
      ...
      {deleted && (
        <div className="flex  justify-between  space-x-2 mt-4">
          <button
            className="bg-white h-10 rounded-lg w-full text-gray-500 text-sm tracking-[-1px]"
            onClick={handleAlert}
          >
            선택삭제
          </button>
          <hr />
          <button
            className="bg-red-500 h-10 rounded-lg w-full text-white text-sm tracking-[-1px]"
            onClick={handleAlert}
          >
            전체삭제
          </button>
