    ...
    <div>
      <div className="h-screen">
        <div className="pt-[15px] pr-[10px] pb-[25px] pl-[10px]">
          {lCategoryDummy.reduce((acc: largeCategoryType[][], item, index) => {
    ...
    <div className='relative left-0 overflow-hidden w-full ' >
      ...
      {isOpen && (
        <ul className="text-xs flex w-full flex-wrap px-3 py-3 bg-gray-100 my-[5px] box-border">
          ...
          <li className="w-1/2 min-h-[38px] flex items-center pl-3 pr-[13px]">
            <p><Link href={'/category/1'} passHref>중분류명</Link></p>
          </li>
          <li className="w-1/2 min-h-[38px] flex items-center pl-3 pr-[13px]">
            <p><Link href={'/category/2'} passHref>중분류명</Link></p>
          </li>
          <li className="w-1/2 min-h-[38px] flex items-center pl-3 pr-[13px]">
            <p><Link href={'/category/3'} passHref>중분류명</Link></p>
          </li>
          <li className="w-1/2 min-h-[38px] flex items-center pl-3 pr-[13px]">
            <p><Link href={'/category/4'} passHref>중분류명</Link></p>
          </li>
          <li className="w-1/2 min-h-[38px] flex items-center pl-3 pr-[13px]">
            <p><Link href={'/category/5'} passHref>중분류명</Link></p>
          </li>
          <li className="w-1/2 min-h-[38px] flex items-center pl-3 pr-[13px]">
            <p><Link href={'/category/6'} passHref>중분류명</Link></p>
          </li>
          <li className="w-1/2 min-h-[38px] flex items-center pl-3 pr-[13px]">
            <p><Link href={'/category/7'} passHref>중분류명</Link></p>
          </li>
