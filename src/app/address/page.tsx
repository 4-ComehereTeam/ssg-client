        ...
        <div>
            ...
            <div className="px-3">
                ...
                <ul>
                    <li className="relative  py-3 pl-10 text-sm " style={{ borderBottom: '1px solid #f0f0f0' }}>
                        ...
                        <div className="relative pl-20">
                            ...
                            >
                                <input className="w-full h-4 " type="text" placeholder="주소별칭 입력" name='addressAlias'/>
                            </span>
                        </div>
                    </li>
                    <li className="relative  py-3 pl-10 text-sm " style={{ borderBottom: '1px solid #f0f0f0' }}>
                        ...
                        <div className="relative pl-20">
                            <span
                                ...
                                style={{ border: '1px solid #ccc', borderRadius: '2px' }}
                            >
                                <input className="w-full h-4 " type="text" placeholder="받는 분 성함 입력" name='receiverName'/>
                            </span>
                        </div>
                    </li>
                    <li className="relative  py-3 pl-10 text-sm " style={{ borderBottom: '1px solid #f0f0f0' }}>
                    ...
                    <li className="relative  py-3 pl-10 text-sm " style={{ borderBottom: '1px solid #f0f0f0' }}>
                        ...
                        <div className="relative pl-20">
                            <span
                                ...
                                style={{ border: '1px solid #ccc', borderRadius: '2px' }}
                            >
                                <input className="w-full h-4 " type="number" placeholder="전화번호(숫자만 입력)" name='number'/>
                            </span>
                        </div>
                    </li>
                    <li className="relative  py-3 pl-10 text-sm " style={{ borderBottom: '1px solid #f0f0f0' }}>
                        ...
                        <div className="relative pl-20 flex items-center">
                            <span className="inline-block flex-1 pr-2">
                                ...
                                >
                                    ...
                                    <input type="number" className="w-full" value={zipCode} readOnly name='zipCode'/>
                                </span>
                            </span>
                ...
                <div className="py-3 text-center flex justify-between w-full mb-6">
                    <button type='reset' className="h-10 flex-1 mr-2 text-xs" style={{ color: '#666', border: '1px solid #ccc' }}>
                        초기화
                    </button>
                    <input value={"취소"} onClick={()=>{history.back()}} className="h-10 flex-1 mr-2 text-xs text-center" style={{ color: '#666', border: '1px solid #ccc' }}>
                    </input>
                    <button type='submit' className="h-10 flex-1 text-xs" style={{ color: '#666', border: '1px solid #ccc' }}>
                        등록
                    </button>
                </div>
                </form>
